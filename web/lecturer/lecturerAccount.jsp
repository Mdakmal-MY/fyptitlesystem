...
<html>
    ...
    <body>
        ...
        %>        
        <div class="content-account" id="content-lecturer-home">
            <div class="content-account-main" id="content-lecturer-main">
            ...
            <form action="./updateaccServlet2" method="POST" class="updateaccForm">
                <table>
                    ...
                    <tr>
                        <td colspan="2"><center>
                        <input type="submit" value="Saved" id="updatestudent"/> 
